...
import com.freelanxx.quickie.game.quickie2048.ui.components.board.Board
import com.freelanxx.quickie.game.quickie2048.ui.model.TileModel
import com.freelanxx.quickie.game.quickie2048.utils.Constants.MERGE_DURATION
import com.freelanxx.quickie.game.quickie2048.utils.Constants.NEW_DURATION
import com.freelanxx.quickie.game.quickie2048.utils.Constants.SWIPE_DURATION
import com.freelanxx.quickie.game.quickie2048.utils.Layer

interface TileRenderer {
    @Composable
    fun Board.RenderNewTile(tileModel: TileModel)

    @Composable
    fun Board.RenderStaticTile(tileModel: TileModel)

    @Composable
    fun Board.RenderSwipedTile(tileModel: TileModel)

    @Composable
    fun Board.RenderMergedTile(tileModel: TileModel)
}
...
object TileRendererInstance : TileRenderer {
    ...
    @Composable
    override fun Board.RenderNewTile(tileModel: TileModel) {
        key(tileModel.id) {
    ...
    @Composable
    override fun Board.RenderStaticTile(tileModel: TileModel) {
        key(tileModel.id) {
            Tile(
                fraction = tileFraction,
                value = tileModel.curValue.toString(),
    ...
    @Composable
    override fun Board.RenderSwipedTile(tileModel: TileModel) {
        key(tileModel.id) {
    ...
    @Composable
    override fun Board.RenderMergedTile(tileModel: TileModel) {
        key(tileModel.id) {
            val scale = remember { Animatable(0f) }
            Tile(
                fraction = tileFraction,
